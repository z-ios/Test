...
- (void)popAnimationToView:(UIView *)zView zWidth:(CGFloat)zWidth zHeight:(CGFloat)zHeight
{
//    self.alpha = 0;
...
//    self.width = zWidth * 0.5;
//    self.height = zHeight * 0.5;
    
//    [UIView animateWithDuration:0.3f delay:0.0f usingSpringWithDamping:0.85f initialSpringVelocity:0.0f options:UIViewAnimationOptionCurveEaseOut animations:^{
//        self.alpha = 1;
