...
- (void)czh_setView {
    ...
    UIButton *sureButton = [UIButton czh_buttonWithTarget:self action:@selector(buttonClick:) frame:CGRectMake(toolBar.czh_width - TOOLBAR_BUTTON_WIDTH, 0, TOOLBAR_BUTTON_WIDTH, toolBar.czh_height) titleColor:[UIColor colorWithHex:@"#26C464"] titleFont:CZHGlobelNormalFont(18) title:@"确定"];
