...
-(void)setWriteInstruction:(NSString *)writeInstruction blePeripheral:(CBPeripheral *)blePeripheral{
    if (writeInstruction) {
        NSData* writeValue = [self dataWithString:writeInstruction];
        [blePeripheral writeValue:writeValue forCharacteristic:_c type:CBCharacteristicWriteWithResponse];
    }
}
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverServices:(NSError *)error;
{
    for (CBService *s in [peripheral services]) {
          ...
          if ([s.UUID.UUIDString isEqualToString:@"6E400011-B5A3-F393-E0A9-E50E24DCCA9E"] || [s.UUID.UUIDString isEqualToString:@"6E400031-B5A3-F393-E0A9-E50E24DCCA9E"]) {
