...
@property (nonatomic, strong) CATextLayer* mintrackCircleLabel;

@property (nonatomic, strong) CATextLayer* maxtrackCircleLabel;

@property (nonatomic, strong) CATextLayer* sliderCircleLabel;
